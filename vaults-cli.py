...
def new(file_name, transaction_type):
    if transaction_type == 'deposit':
        ...
        tx = tt.new_unvault_transaction(file_name)

    elif transaction_type == 'p2rw':
        tx = tt.new_p2rw_transaction(file_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-sid', '--session_id', action='store', nargs='?', default=0)
    ...
    if transaction_type == {}:
        ...
        file_name = str(sid) + '_' + [value for (key, value) in transaction_type.items()][0]
